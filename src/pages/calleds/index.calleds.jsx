...
class Calleds extends React.Component {
      ...
      <>
        ...
        <PageContent>
          ...
          <Nav appearance="subtle">
            <Nav.Item eventKey="home" active><center style={{width: 100}}>Todos<br></br>{this.state?.loading ? '-' : '10'}</center></Nav.Item>
            <Nav.Item eventKey="news"><center style={{width: 100}}>Abertos<br></br>{this.state?.loading ? '-' : '6'}</center></Nav.Item>
            <Nav.Item eventKey="news"><center style={{width: 100}}>Atrasados<br></br>{this.state?.loading ? '-' : '1'}</center></Nav.Item>
            <Nav.Item eventKey="news"><center style={{width: 100}}>Concluídos<br></br>{this.state?.loading ? '-' : '3'}</center></Nav.Item>
          </Nav>
          ...
          <Stack direction='row' alignItems='flexStart' justifyContent='space-between'>
            ...
            <Button appearance='primary' color='blue' startIcon={<MdAddCircleOutline />} onClick={this.onNewUser}>Novo chamado</Button>
